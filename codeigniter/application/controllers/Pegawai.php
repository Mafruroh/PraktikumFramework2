...
class Pegawai extends CI_Controller {
	...
	public function create()
	{
		...
		$this->form_validation->set_rules('nama', 'Nama', 'trim|required|min_lenght[3]|max_length[100]');

		$this->form_validation->set_rules('nip', 'Nip', 'trim|required|min_length[3]|max_length[15]|numeric');

		$this->form_validation->set_rules('tanggalLahir','
			tanggalLahir', 'trim|required|min_length[3]|max_length[15]');
